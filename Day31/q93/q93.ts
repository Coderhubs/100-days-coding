...
function replacebananawithmango (fvrtfruits:string[]): void{
    const index = fvrtfruits.indexOf("Banana");
    if (index !== -1) fvrtfruits[index] = "Mango"; // Replaces "Banana" with "Mango" if found
}

// Example: Replacing "Banana" in the array
const fvrtfruits: string[] = ["Kiwi", "Banana", "strawberry"];
